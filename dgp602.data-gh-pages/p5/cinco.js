...
function draw(){
  ...
  textAlign(LEFT);
  textSize(20);
  text(hxd.get(chile,1)+" / "+ (hxd.get(thailand,1)),((width/30)-10),50);
  for (var i = 0; i < (hxd.getRowCount()+4); i++){
    textSize(11);
    textAlign(CENTER);
    fill(100);
    text(hxd.get(chile,(3+i)), ((width/30)*(i+1)), (height-30)-hxd.get(chile,(3+i)));
    text(hxd.get(thailand,(3+i)), ((width/30)*(i+1)), (height-30)-hxd.get(thailand,(3+i)));
